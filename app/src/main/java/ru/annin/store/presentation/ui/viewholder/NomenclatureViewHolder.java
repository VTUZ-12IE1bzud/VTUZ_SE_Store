...
import ru.annin.store.presentation.ui.adapter.NomenclatureAdapter;

/**
 * <p>ViewHolder экрана "Номенклатуры".</p>
 *
 * @author Pavel Annin.
 */
public class NomenclatureViewHolder extends BaseViewHolder {
    ...
    public NomenclatureViewHolder showNomenclatures(final RealmResults<NomenclatureModel> models) {
        adapter.updateRealmResults(models);
        return this;
    }

    public NomenclatureViewHolder insertItem(int position) {
        adapter.notifyItemInserted(position);
        return this;
    }

    public NomenclatureViewHolder showMessage(@StringRes int text) {
    ...
    private final NomenclatureAdapter.OnClickListener onItemClickListener = model -> {
        if (listener != null) {
    ...
    public interface OnClickListener {
        ...
        void onRemoveItem(NomenclatureModel model, int position);
